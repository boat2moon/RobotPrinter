...
export const RobotHead = forwardRef<HTMLDivElement, RobotHeadProps>(
  (
    ...
    return (
      ...
      <div ref={ref} className="robot-head-wrapper" onClick={onClick}>
        {/* 内层头部可旋转 */}
        <div className={`robot-head ${isRotated ? 'rotated' : ''}`} style={headInnerStyle}>
          {/* 天线 - 加载时呼吸灯，可点击终止 */}
          <Antenna ballColor={antennaBallColor} loading={loading} onBallClick={onAbort} />
          ...
          <div className="head-body">
            ...
            <div className="face-screen">
              ...
              />
              {/* 嘴巴 */}
              <div ref={mouthRef} className={`mouth ${isMouthOpen ? 'open' : ''}`} />
            </div>
